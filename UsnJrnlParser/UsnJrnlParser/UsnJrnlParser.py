...
print("Full metadata dump: \n", extend[firstAttOffset+208:])

print("\n$Index_Root Header")
print("Attribute Type: " + str(extend[firstAttOffset+208:firstAttOffset+212]))
print("Collation Rule: " + str(extend[firstAttOffset+212:firstAttOffset+216]))
print("Bytes per Index Record: " + str(extend[firstAttOffset+216:firstAttOffset+222]))
print("Clusters per Index Record: " + str(extend[firstAttOffset+222:firstAttOffset+223]))
print("Index Node Header: " + str(extend[firstAttOffset+226:firstAttOffset+232]))
print("Index Entry?: " + str(extend[firstAttOffset+232:firstAttOffset+264]))
"""
